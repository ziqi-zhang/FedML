...
class PredWeightClass(torch.nn.Module):
    def __init__(self, branches, clients, args, output_dim=10):
        super(PredWeightClass, self).__init__()
        ...
        self.branch_weight = nn.Parameter(torch.ones((self.branch_num, output_dim)) / self.branch_num)
    ...
    def forward(self, x):
        ...
        preds *= self.branch_weight.view(self.branch_num,1,self.output_dim)
